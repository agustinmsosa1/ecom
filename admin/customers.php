  ...
  if (tep_not_null($action)) {
    switch ($action) {
      case 'update':
        ...
        $entry_nif = tep_db_prepare_input($_POST['entry_nif']); // NIF
      ...
      default:
        //NIF start
        $customers_query = tep_db_query("select c.customers_id, c.customers_gender, c.customers_firstname, c.customers_lastname, c.customers_dob, c.customers_email_address, c.customers_default_address_id, a.entry_company, a.entry_street_address, a.entry_suburb, a.entry_postcode, a.entry_city, a.entry_state, a.entry_zone_id, a.entry_country_id, c.customers_telephone, c.customers_fax, c.customers_newsletter, c.customers_default_address_id, c.entry_nif from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$_GET['cID'] . "'");
        //NIF end
...
?>
          <tr>
            ...
            <td class="main">
<?php
    $entry_state = tep_get_zone_name($cInfo->entry_country_id, (isset($cInfo->entry_zone_id)?$cInfo->entry_zone_id:null), $cInfo->entry_state);
    if ($error == true) {
...
<?php
    ...
    $customers_query_raw = "select c.customers_id, c.customers_lastname, c.customers_firstname, c.customers_email_address, c.customers_default_address_id, a.entry_country_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_id = a.customers_id and c.customers_default_address_id = a.address_book_id " . $search . " order by c.customers_lastname, c.customers_firstname";
