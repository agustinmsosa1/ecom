...
define('TEXT_BANNERS_INSERT_NOTE', '<strong>Notas sobre la Imagen:</strong><ul><li>El directorio donde suba la imagen debe de tener configurados los permisos de escritura necesarios!</li><li>No rellene el campo \'Guardar en\' si no va a subir una imagen al servidor (como cuando usa una imagen ya existente en el servidor -Archivo local).</li><li>El campo \'Grabar en\' debe de ser un directorio que existe y terminado en una barra (por ejemplo: banners/).</li></ul>');
...
define('TEXT_BANNERS_SCHEDULED_AT_DATE', 'Programado para el dia: <strong>%s</strong>');
