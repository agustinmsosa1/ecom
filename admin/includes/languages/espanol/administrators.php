...
define('HTPASSWD_SECURED', '<strong>Protección adicional con htaccess/htpasswd</strong><p>Esta Instalación de la Herramienta de Administración osCommerce Online Merchant no está adicionalmente protegida a través de htaccess/htpasswd.</p>');
