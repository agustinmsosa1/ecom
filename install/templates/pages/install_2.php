...
<div class="row">
  <div class="col-sm-9">
    <div class="alert alert-info">
      ...
      <p>Esta rutina de instalación basado en la web va a instalar y configurar correctamente la tienda osCommerce para ejecutarla en este servidor.</p>
      <p>Por favor, siga las instrucciones en pantalla que le guiarán a través del servidor de la base de datos, del servidor web, y las opciones de configuración de la tienda. Si necesita ayuda en cualquiera de los pasos, por favor consulte la documentación o busque ayuda en los foros de soporte de la comunidad.</p>
    </div>
  </div>
  <div class="col-sm-3">
