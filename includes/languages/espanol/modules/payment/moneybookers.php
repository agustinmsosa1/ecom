...
*/
  ...
  define('MB_ACTIVATION_EMAIL_ADDRESS', 'Moneybookers Account correo electrónico Address:');
  ...
  define('MB_ACTIVATION_NONEXISTING_ACCOUNT_TEXT', 'The correo electrónico address is not a registered Moneybookers account. Please <a href="http://www.moneybookers.com/partners/oscommerce" target="_blank">register here</a> to begin selling with Moneybookers.');
