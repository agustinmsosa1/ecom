...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_EC_EMAIL_PASSWORD', 'An account has automatically been created for you with the following correo electrónico address and password:' . "\n\n" . 'Store Account correo electrónico Address: %s' . "\n" . 'Store Account Password: %s' . "\n\n");
